    ...
    >
      <span className="w-4 h-4" aria-hidden="true">
        {currentThemeMode === 'light' ? (
          <svg className="h-full w-full fill-current" viewBox="2 3 27 27" fill="currentColor" style={{ color: accentColor }}>
          ...
          <svg className="h-full w-full fill-current" viewBox="-1 -1 26 26" fill="currentColor" style={{ color: accentColor }}>
